...
begin
  ShellExecute(Handle,'open','https://github.com/agebhar1/sim8008-ioeditor','','',SW_MAXIMIZE);
end;

procedure TInfoForm.LbleMailClick(Sender: TObject);
begin
  ShellExecute(Handle,'open','mailto:agebhar1@googlemail.com?subject=8008 - I/O Editor Version 1','','',SW_NORMAL);
end;
